...
use backend\models\IdiomaSearch;
...
class IdiomaController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax)
        {
            ...
            */
            ...
            {
                return [
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New')." Idioma",
            ...
            else if($model->load($request->post()) && $model->save())
            {
                return [
                    ...
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New')." Idioma",
                    'content' => '<span class="text-success">'.Yii::t('yii2-ajaxcrud', 'Create').' Idioma '.Yii::t('yii2-ajaxcrud', 'Success').'</span>',
                    'footer' =>  Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => 'modal']).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax)
        {
            ...
            */
            ...
            {
                return [
                    'title' => Yii::t('yii2-ajaxcrud', 'Update')." Idioma #".$id,
    ...
    /**
     * Delete an existing Idioma model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Idioma model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
