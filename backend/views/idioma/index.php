...
/* @var $searchModel backend\models\IdiomaSearch */
...
<div class="container-fluid py-3 idioma-index">
                ...
                <?= GridView::widget([
                    ...
                    'toolbar' => [
                        [
                            'content' =>
                            Html::a(
                                '<i class="bi bi-plus-circle me-1"></i> ' . Yii::t('app', 'Novo Idioma'),
                                ['create'],
                                [
                                    'role' => 'modal-remote',
                                    'title' => Yii::t('app', 'Novo Idioma'),
