...
/* @var $searchModel backend\models\NotificacaoSistemaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Notificações do Sistema');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);
?>

<div class="container-fluid py-3 notificacao-sistema-index">
                ...
                <?= GridView::widget([
                    ...
                    'toolbar' => [
                        [
                            'content' =>
                            Html::a(
                                '<i class="bi bi-plus-circle me-1"></i> ' . Yii::t('app', 'Nova Notificação'),
                                ['create'],
                                [
                                    'role' => 'modal-remote',
                                    'title' => Yii::t('app', 'Nova Notificação'),
