...
$this->title = Yii::t('app', 'Ticket Tipos');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="ticket-tipo-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Ticket Tipos','class' => 'btn btn-outline-primary']).
