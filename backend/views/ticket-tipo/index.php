...
/* @var $searchModel backend\models\TicketTipoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Tipos de Ticket');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);
?>
<div class="container-fluid py-3 ticket-tipo-index">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="bi bi-ticket-perforated-fill me-1"></i> <?= Html::encode($this->title) ?>
            </h5>
        </div>
        <div class="card-body">
                ...
                <?= GridView::widget([
                    ...
                    'toolbar' => [
                        [
                            'content' =>
                                Html::a(
                                    '<i class="bi bi-plus-circle me-1"></i> ' . Yii::t('app', 'Novo Tipo'),
                                    ['create'],
                                    [
                                        'role' => 'modal-remote',
                                        'title' => Yii::t('app', 'Novo Tipo'),
